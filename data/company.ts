...
export const companyConfig: CompanyConfig = {
  // اسم الشركة
  name: "سباك برو الطائف | خدمات السباكة المتكاملة",
  nameEn: "SpakPro Plumbing Services - Taif",
  tagline: "أفضل سباك في الطائف - خدمات سباكة احترافية وسريعة 24 ساعة",
  subTagline: "فريق فني معتمد في الطائف متاح 24/7 للتعامل مع كافة مشكلات السباكة الطارئة والتركيبات الحديثة بأحدث المعدات.",
