...
export const metadata: Metadata = {
  title: "تواصل معنا | سباك الطائف - حجز فني واستشارات فورية",
  description:
    "تواصل مباشرة مع سباك برو الطائف لخدمات السباكة المتكاملة عبر الهاتف 0560935248، واتساب، أو حجز موعد مباشر. خدمة طوارئ 24 ساعة في جميع أحياء الطائف.",
};
