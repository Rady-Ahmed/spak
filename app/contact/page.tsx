...
export const metadata: Metadata = {
  title: "تواصل معنا | حجز فني واستشارات فورية",
  description:
    "تواصل مباشرة مع سباك برو لخدمات السباكة المتكاملة عبر الهاتف، واتساب، أو حجز موعد مباشر من خلال النموذج الإلكتروني المعتمد.",
};
          ...
          <div className="lg:col-span-5 space-y-6">
            ...
            <div className="p-6 rounded-3xl bg-slate-900 border border-slate-800 shadow-xl text-right">
              ...
              <p className="text-xs text-slate-400 leading-relaxed mb-4">
                تغطي سياراتنا المتنقلة كافة مناطق القاهرة الكبرى والجيزة.
              </p>
              <a
