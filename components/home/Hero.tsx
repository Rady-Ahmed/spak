    ...
    <section className="relative min-h-[92vh] flex items-center justify-center pt-28 pb-16 lg:pt-36 lg:pb-24 overflow-hidden bg-gradient-to-b from-slate-950 via-[#0a1628] to-slate-950 text-white">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          ...
          {/* Right Column: Premium Plumbing Technical Composition Visual */}
          <div className="lg:col-span-5 relative">
            <div className="relative mx-auto max-w-md lg:max-w-none">
              ...
              {/* Technical Card Visual Composition */}
              <div className="relative rounded-3xl bg-gradient-to-b from-slate-900 via-slate-900/90 to-slate-950 p-6 sm:p-8 border border-slate-700/70 shadow-2xl overflow-hidden">
                {/* Visual Header */}
                <div className="flex items-center justify-between pb-6 border-b border-slate-800">
                  <div className="flex items-center gap-3">
                    <div className="w-12 h-12 rounded-2xl bg-gradient-to-tr from-blue-600 to-cyan-400 flex items-center justify-center text-white shadow-lg shadow-blue-600/30">
                      <Wrench className="w-6 h-6" />
                    </div>
                    <div>
                      <h2 className="font-extrabold text-base text-white">
                        محطة تشخيص السباكة الذكية
                      </h2>
                      <p className="text-xs text-cyan-400 font-medium">
                        دقة الفحص 99.4% بدون تكسير
                      </p>
                    </div>
                  </div>
                  <span className="text-[10px] uppercase font-bold tracking-widest px-2.5 py-1 rounded bg-emerald-500/20 text-emerald-400 border border-emerald-500/30">
                    LIVE
                  </span>
                </div>
                ...
                <div className="grid grid-cols-2 gap-3.5 my-6">
                  <div className="p-4 rounded-2xl bg-slate-950/70 border border-slate-800/80">
                    ...
                    <div className="text-xl font-extrabold text-white">4.8 BAR</div>
                    <p className="text-[11px] text-emerald-400 mt-1">مستقر ومثالي</p>
                  </div>

                  <div className="p-4 rounded-2xl bg-slate-950/70 border border-slate-800/80">
                    <div className="flex items-center gap-2 text-amber-400 text-xs font-semibold mb-1">
                      <Flame className="w-4 h-4" />
                      <span>كفاءة السخانات</span>
                    </div>
                    <div className="text-xl font-extrabold text-white">100%</div>
                    <p className="text-[11px] text-cyan-400 mt-1">أمان معزول</p>
                  </div>
                </div>

                {/* Interactive Diagnostic Checklist */}
                <div className="space-y-2.5 bg-slate-950/50 p-4 rounded-2xl border border-slate-800/60">
                  <div className="flex items-center justify-between text-xs">
                    <span className="text-slate-300">أجهزة فحص صوتي ألمانية</span>
                    <span className="text-emerald-400 font-bold">جاهزة للعمل</span>
                  </div>
                  <div className="flex items-center justify-between text-xs">
                    <span className="text-slate-300">سوست تسليك هيدروليكية</span>
                    <span className="text-emerald-400 font-bold">جاهزة للعمل</span>
                  </div>
                  <div className="flex items-center justify-between text-xs">
                    <span className="text-slate-300">لحام حراري بولي بروبلين</span>
                    <span className="text-emerald-400 font-bold">معاير رقمياً</span>
                  </div>
                </div>

                {/* Floating emergency badge */}
                <div className="mt-6 p-3.5 rounded-2xl bg-gradient-to-r from-blue-900/50 via-cyan-900/30 to-slate-900 border border-cyan-500/30 flex items-center justify-between">
                  <div className="flex items-center gap-3">
