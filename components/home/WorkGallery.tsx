...
export const WorkGallery: React.FC = () => {
  ...
  const projects: GalleryProject[] = [
    ...
    {
      id: "p2",
      title: "تأسيس شبكة تغذية وصرف متكاملة لشقة دوبلكس",
      category: "مواسير",
      location: "الشيخ زايد",
      badge: "تأسيس معتمد",
      summary: "تمديد شبكة مواسير بولي بروبلين خضراء معزولة حرارياً بالكامل وتوزيع خطوط ضغط متوازنة لـ 3 حمامات ومطبخ رئيسي.",
      beforeState: "شبكة حديد قديمة متآكلة تسبب انخفاض حاد في ضغط المياه وتغير لون الماء إلى صدأ بني خفيف.",
      afterState: "استبدال كامل للمنظومة بشبكة بولي بروبلين معتمدة مطابقة للمواصفات الألمانية وضمان مصنعي 10 سنوات.",
    ...
    {
      id: "p4",
      title: "إصلاح وصيانة سخان غاز مركزي واستبدال السربنتينة",
      category: "سخانات",
      location: "المعادي",
      badge: "أمان متكامل",
      summary: "إزالة التكلسات الملحية من دورة التسخين، ضبط صمام الأمان وتغيير الرداخ الأصلي لاستعادة تدفق المياه الساخنة بكفاءة 100%.",
      beforeState: "السخان يفصل بعد دقيقة واحدة من الاشتعال مع ضعف حاد في ضغط المياه الساخنة وتنقيط أسفل الجهاز.",
      afterState: "تنظيف السربنتينة بمحلول فوسفاتي آمن، تغيير الرداخ وضبط حساس الأمان واشتعال فوري سلس.",
      toolsUsed: ["رداخ أصلي مطابقة للمصنع", "أجهزة كشف تسريب الغاز", "مضخة غسيل السربنتينة"],
      specs: ["قطع غيار أصلية", "فحص تسريب غاز", "معايرة درجة الحرارة"],
      executionTime: "ساعة واحدة",
    },
    {
      id: "p5",
